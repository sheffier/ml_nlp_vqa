...
__C.VOCAB_LAYOUT_FILE = './exp_nlvr/data/vocabulary_layout.txt'
__C.VOCAB_ANSWER_FILE = './exp_nlvr/data/answers_nlvr.txt'
__C.IMDB_FILE = './exp_nlvr/data/imdb/imdb_%s.npy'
...
__C.MODEL.INPUT.USE_LEFT_RIGHT_ENCODING = False
